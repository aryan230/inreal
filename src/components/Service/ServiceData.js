const ServiceData = {
  STitle: "Services we provide for you.",
  Service: [
    {
      id: 1,
    ...
    },
    {
      ...
      description:
        "Web management is a crucial aspect of website ownership that can save time, money, while ensuring that the website remains a valuable asset for the business.",
      btn: "Read More",
      bicon: "ti-arrow-right",
    },
  ],
